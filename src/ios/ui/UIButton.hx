...
class UIButton extends UIControl
{
	...
	public function setImagePath(arg1:String, arg2:Int):Void
	{
		cpp_uibutton_setImagePath(_tag, arg1, arg2);
	}
	private static var cpp_uibutton_setImagePath = Lib.load("basis", "uibutton_setImagePath", 3);
