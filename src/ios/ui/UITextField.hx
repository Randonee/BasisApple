...
class UITextField extends UIControl
{
	...
	static public inline var UITextBorderStyleNone:Int = 0;
	static public inline var UITextBorderStyleLine:Int = 1;
	static public inline var UITextBorderStyleBezel:Int = 2;
	static public inline var UITextBorderStyleRoundedRect:Int = 3;
