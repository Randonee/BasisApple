...
class UIViewController extends UIResponder
{
	...
	public static inline var UIModalTransitionStyleCoverVertical:Int = 0;
	public static inline var UIModalTransitionStyleFlipHorizontal:Int = 1;
	public static inline var UIModalTransitionStyleCrossDissolve:Int = 2;
	public static inline var UIModalPresentationFullScreen:Int = 0;
